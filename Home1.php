...
<!-- Latest compiled and minified JavaScript -->
	...
	<body>		
		...
		<button class="fa fa-sign-out" style="font-size:18px;margin-left:107px;" onclick="window.location='./logout.php' "></button><br><br>
		 ...
		 <h3 style="color:pink;margin-left:50px;">Recently followed people</h3>
		<?php
		$query7 = "SELECT * FROM followers WHERE follower_id='$username' ORDER BY id DESC LIMIT 8";
		$sql5 = mysqli_query($con,$query7);?>
		<div class="container">
		<ul class="pagination">
		<?php while($row7 = mysqli_fetch_assoc($sql5))
		   {?>
           <li><a class="pa" href="search.php?username=<?php echo $row7["username"];?>"><?php echo $row7['username'] ?></a></li>
		   <?php
		   }
		   ?>
		   </ul>
...
$query5 = "SELECT username FROM followers WHERE follower_id='$user1'";
$result5 = mysqli_query($con,$query5);
$row6 = mysqli_fetch_array($result5);
$follower1 = $row6[0];
$query2 = "(SELECT * FROM post WHERE username='$follower1')UNION(SELECT * FROM post)";
